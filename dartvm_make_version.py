#!/usr/bin/env python3
"""
dartvm_make_version.py — Génère runtime/vm/version.cc pour la Dart VM.

Usage :
  python dartvm_make_version.py /path/to/dart-sdk <snapshot_hash_32hex>
  python dartvm_make_version.py /path/to/dart-sdk <snapshot_hash> --dry-run
"""
...
def generate_version_cc(
    ...
    if len(snapshot_hash) != 32 or not re.fullmatch(r"[0-9a-fA-F]{32}", snapshot_hash):
        print(
